...
import '../ui/screens/create_account.dart' as _i10;
import '../ui/screens/dentist_achievement.dart' as _i33;
import '../ui/screens/find_doctor/find_doctor.dart' as _i18;
...
import '../ui/screens/main/pre_auth/login.dart' as _i13;
...
import '../ui/screens/onboarding/allow_notifications.dart' as _i28;
...
import '../ui/screens/onboarding/fallback_account/email.dart' as _i12;
import '../ui/screens/onboarding/fallback_account/nickname.dart' as _i11;
...
import '../ui/screens/settings/edit_email.dart' as _i39;
import '../ui/screens/settings/edit_nickname.dart' as _i38;
import '../ui/screens/settings/edit_photo.dart' as _i40;
import '../ui/screens/settings/gallery_photo_taken.dart' as _i42;
import '../ui/screens/settings/leaderboard.dart' as _i44;
import '../ui/screens/settings/open_settings.dart' as _i36;
import '../ui/screens/settings/photo_cropped_result.dart' as _i43;
import '../ui/screens/settings/points_help.dart' as _i45;
import '../ui/screens/settings/update_profile.dart' as _i37;
import '../ui/screens/splash_screen.dart' as _i15;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    CreateAccountRoute.name: (routeData) {
      ...
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: _i10.CreateAccountScreen(key: args.key));
    },
    NicknameRoute.name: (routeData) {
      ...
      return _i1.MaterialPageX<void>(
          routeData: routeData,
          child: _i11.NicknameScreen(key: args.key, authUser: args.authUser));
    },
    EmailRoute.name: (routeData) {
      ...
      return _i1.MaterialPageX<void>(
          routeData: routeData,
          child: _i12.EmailScreen(key: args.key, authUser: args.authUser));
    },
    LoginRoute.name: (routeData) {
      final args = routeData.argsAs<LoginRouteArgs>(
          orElse: () => const LoginRouteArgs());
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: _i13.LoginScreen(key: args.key));
    },
    ...
    SplashRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: const _i15.SplashScreen());
    },
    WelcomeRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: const _i16.WelcomeScreen());
    },
    ...
    FindDoctorRoute.name: (routeData) {
      ...
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: _i18.FindDoctorScreen(key: args.key));
    },
    AboutHealthRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: const _i19.AboutHealthScreen());
    },
    ...
    ContinueOnboardingFormRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData,
          child: const _i21.ContinueOnboardingFormScreen());
    },
    OnboardingFormDoneRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: const _i22.OnboardingFormDoneScreen());
    },
    ...
    AllowNotificationsRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i28.AllowNotificationsScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    ...
    OpenSettingsRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i36.OpenSettingsScreen(key: args.key),
    ...
    UpdateProfileRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i37.UpdateProfileScreen(key: args.key),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditNicknameRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i38.EditNicknameScreen(key: args.key, user: args.user),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditEmailRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i39.EditEmailScreen(key: args.key, user: args.user),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditPhotoRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child:
              _i40.EditPhotoScreen(key: args.key, imageBytes: args.imageBytes),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    ...
    CancelCheckupRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i51.CancelCheckupScreen(
              key: args.key,
    ...
    ChangeLastVisitRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i52.ChangeLastVisitScreen(
              key: args.key,
...
class NicknameRoute extends _i1.PageRouteInfo<NicknameRouteArgs> {
  NicknameRoute({_i2.Key? key, _i55.AuthUser? authUser})
      : super(name,
...
class NicknameRouteArgs {
  ...
  final _i55.AuthUser? authUser;
}

class EmailRoute extends _i1.PageRouteInfo<EmailRouteArgs> {
  EmailRoute({_i2.Key? key, _i55.AuthUser? authUser})
      : super(name,
...
class OnboardingFormDoneRoute extends _i1.PageRouteInfo<void> {
  const OnboardingFormDoneRoute() : super(name, path: 'onboarding-form-done');
...
class OnBoardingBirthdateRoute
  ...
  OnBoardingBirthdateRoute({_i2.Key? key, required _i56.Sex sex})
      : super(name,
            path: 'birthdate',
...
class OnboardingGeneralPracticionerRoute
  ...
  OnboardingGeneralPracticionerRoute({_i2.Key? key, required _i56.Sex sex})
      : super(name,
            path: 'doctor/general-practicioner',
...
class OnboardingGynecologyRoute
  ...
  OnboardingGynecologyRoute({_i2.Key? key, required _i56.Sex sex})
      : super(name,
            path: 'doctor/gynecology',
...
class OnboardingDentistRoute
  ...
  OnboardingDentistRoute({_i2.Key? key, required _i56.Sex sex})
      : super(name,
            path: 'doctor/dentist',
...
class EditNicknameRoute extends _i1.PageRouteInfo<EditNicknameRouteArgs> {
  EditNicknameRoute({_i2.Key? key, required _i57.User? user})
      : super(name,
            path: 'settings/update-profile/nickname',
...
class EditEmailRoute extends _i1.PageRouteInfo<EditEmailRouteArgs> {
  EditEmailRoute({_i2.Key? key, required _i57.User? user})
      : super(name,
            path: 'settings/update-profile/email',
...
class EditPhotoRoute extends _i1.PageRouteInfo<EditPhotoRouteArgs> {
  EditPhotoRoute({_i2.Key? key, _i58.Uint8List? imageBytes})
      : super(name,
            path: 'settings/update-profile/photo',
...
class CameraPhotoTakenRoute
  ...
  CameraPhotoTakenRoute({_i2.Key? key, required _i58.Uint8List imageBytes})
      : super(name,
            path: 'settings/update-profile/photo/camera-taken',
...
class GalleryPhotoTakenRoute
  ...
  GalleryPhotoTakenRoute({_i2.Key? key, required _i58.Uint8List imageBytes})
      : super(name,
            path: 'settings/update-profile/photo/gallery-taken',
...
class PhotoCroppedResultRoute
  ...
  PhotoCroppedResultRoute({_i2.Key? key, required _i58.Uint8List imageBytes})
      : super(name,
            path: 'settings/update-profile/photo/photo-cropped-result',
            args:
...
class CalendarPermissionInfoRoute
  ...
  CalendarPermissionInfoRoute(
      {_i2.Key? key, required _i60.ExaminationRecordTemp examinationRecord})
      : super(name,
            path: 'calendar/permission',
...
class CalendarPermissionInfoRouteArgs {
  ...
  final _i60.ExaminationRecordTemp examinationRecord;
}
