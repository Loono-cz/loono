...
import '../helpers/examination_extensions.dart' as _i44;
import '../helpers/sex_extensions.dart' as _i47;
import '../models/categorized_examination.dart' as _i43;
import '../models/firebase_user.dart' as _i42;
import '../services/db/database.dart' as _i45;
import '../ui/screens/create_account.dart' as _i5;
import '../ui/screens/dentist_achievement.dart' as _i40;
import '../ui/screens/general_practicioner_achievement.dart' as _i33;
import '../ui/screens/gynecology_achievement.dart' as _i37;
import '../ui/screens/login.dart' as _i8;
import '../ui/screens/logout.dart' as _i9;
import '../ui/screens/main/main_screen.dart' as _i10;
import '../ui/screens/onboarding/allow_notifications.dart' as _i35;
import '../ui/screens/onboarding/birthdate.dart' as _i31;
import '../ui/screens/onboarding/carousel/carousel.dart' as _i29;
import '../ui/screens/onboarding/doctors/dentist.dart' as _i39;
import '../ui/screens/onboarding/doctors/dentist_date.dart' as _i41;
import '../ui/screens/onboarding/doctors/general_practicioner.dart' as _i32;
import '../ui/screens/onboarding/doctors/general_practitioner_date.dart'
    as _i34;
import '../ui/screens/onboarding/doctors/gynecology.dart' as _i36;
import '../ui/screens/onboarding/doctors/gynecology_date.dart' as _i38;
...
import '../ui/screens/onboarding/gender.dart' as _i30;
...
import '../ui/screens/settings/camera_photo_taken.dart' as _i23;
import '../ui/screens/settings/edit_email.dart' as _i21;
import '../ui/screens/settings/edit_nickname.dart' as _i20;
import '../ui/screens/settings/edit_photo.dart' as _i22;
import '../ui/screens/settings/gallery_photo_taken.dart' as _i24;
import '../ui/screens/settings/leaderboard.dart' as _i26;
import '../ui/screens/settings/open_settings.dart' as _i18;
import '../ui/screens/settings/photo_cropped_result.dart' as _i25;
import '../ui/screens/settings/points_help.dart' as _i27;
import '../ui/screens/settings/update_profile.dart' as _i19;
import '../ui/screens/welcome.dart' as _i28;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    OpenSettingsRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i18.OpenSettingsScreen(key: args.key),
    ...
    UpdateProfileRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i19.UpdateProfileScreen(key: args.key),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditNicknameRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i20.EditNicknameScreen(key: args.key, user: args.user),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditEmailRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i21.EditEmailScreen(key: args.key, user: args.user),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    EditPhotoRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child:
              _i22.EditPhotoScreen(key: args.key, imageBytes: args.imageBytes),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    CameraPhotoTakenRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i23.CameraPhotoTakenScreen(
    ...
    GalleryPhotoTakenRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i24.GalleryPhotoTakenScreen(
              key: args.key, imageBytes: args.imageBytes),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    ...
    PhotoCroppedResultRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i25.PhotoCroppedResultScreen(
              key: args.key, imageBytes: args.imageBytes),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    ...
    LeaderboardRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i26.LeaderboardScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    PointsHelpRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i27.PointsHelpScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    WelcomeRoute.name: (routeData) {
      return _i1.MaterialPageX<void>(
          routeData: routeData, child: const _i28.WelcomeScreen());
    },
    OnboardingCarouselRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i29.OnboardingCarouselScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    OnboardingGenderRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i30.OnboardingGenderScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    OnBoardingBirthdateRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i31.OnBoardingBirthdateScreen(key: args.key, sex: args.sex),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    OnboardingGeneralPracticionerRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i32.OnboardingGeneralPracticionerScreen(
    ...
    GeneralPracticionerAchievementRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i33.GeneralPracticionerAchievementScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    GeneralPractitionerDateRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i34.GeneralPractitionerDateScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    AllowNotificationsRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i35.AllowNotificationsScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    OnboardingGynecologyRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i36.OnboardingGynecologyScreen(key: args.key, sex: args.sex),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    GynecologyAchievementRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i37.GynecologyAchievementScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    GynecologyDateRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i38.GynecologyDateScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    OnboardingDentistRoute.name: (routeData) {
      ...
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: _i39.OnboardingDentistScreen(key: args.key, sex: args.sex),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    DentistAchievementRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i40.DentistAchievementScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    },
    DentistDateRoute.name: (routeData) {
      return _i1.CustomPage<void>(
          routeData: routeData,
          child: const _i41.DentistDateScreen(),
          transitionsBuilder: _i1.TransitionsBuilders.slideLeft,
          opaque: true,
          barrierDismissible: false);
    }
...
class NicknameRoute extends _i1.PageRouteInfo<NicknameRouteArgs> {
  NicknameRoute({_i2.Key? key, _i42.AuthUser? authUser})
      : super(name,
...
class NicknameRouteArgs {
  ...
  final _i42.AuthUser? authUser;
}

class EmailRoute extends _i1.PageRouteInfo<EmailRouteArgs> {
  EmailRoute({_i2.Key? key, _i42.AuthUser? authUser})
      : super(name,
...
class ExaminationDetailRoute
  ...
  ExaminationDetailRoute(
      {_i2.Key? key,
      required _i43.CategorizedExamination categorizedExamination})
      : super(name,
            path: 'prevention-detail',
...
class ExaminationDetailRouteArgs {
  ...
  final _i43.CategorizedExamination categorizedExamination;
}
...
class CalendarPermissionInfoRoute
  ...
  CalendarPermissionInfoRoute(
      {_i2.Key? key, required _i44.ExaminationRecord examinationRecord})
      : super(name,
            path: 'calendar/permission',
...
class CalendarPermissionInfoRouteArgs {
  ...
  final _i44.ExaminationRecord examinationRecord;
}
